...
### Manually
To regenerate the template files _manually_, execute the following steps from the `scripts` folder. 
...
```
with the default being set as `../genomics_template_schema.json`. 
