...
def update_controlled_vocabularies():
    ...
    yaml_file_path = files("scilifelab_metadata_templates.genomics.data").joinpath(
        "technical_metadata_fields_incl_ENA_CVs.yml"
    )
    ...
    yaml_file_path = os.path.join(
        folder_path, "technical_metadata_fields_incl_ENA_CVs.yml"
    )
